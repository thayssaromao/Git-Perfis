<script lang="ts"> 
    ...
    export let usuario: IUsuario //variavel filho

    $: hasRepo = Boolean( usuario.repos_recentes.length) 
    //rotulo reativo, execuçao sempre que houver uma mudança
</script>
...
<div class="card-usuario">
	...
	<div class="usuario">
      ...
      <div class="info">
				Local: <span>{usuario.location}</span>
			</div>
		</div>
    ...
    {#if hasRepo}
      <div class="repositorios">
        ...
        <ul>
          ...
          {#each usuario.repos_recentes as repositorio}
              <li>
                <a 
